...
- `scripts/qa_ui_crawler.py` — 로그인 목적지, 공통 헤더의 홈·프로필·로그아웃·테마 순서, 수영 아이콘, 역할별 주요 35개 페이지와 고정 fixture 기반 공개 결과 카드·클럽 초대 2개 화면의 DOM·PC/390px 겹침·결과 PNG·초대 경로·콘솔 오류를 점검
