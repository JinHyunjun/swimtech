...
직전 기준 핵심 115개는 로컬과 GitHub Actions [`31243260223`](https://github.com/JinHyunjun/swimtech/actions/runs/31243260223)에서 통과했습니다. 현재 운영 UI 정의는 사용 가이드 허브와 5개 상세 페이지를 포함한 역할별 브라우저 33개 화면이며, 인증 Secrets가 필요한 운영 API 51개와 Postman 요청 20개 전체 일괄 검사는 정기·수동 품질 게이트에서 판정합니다.
