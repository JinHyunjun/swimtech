...
- 장비 가이드의 수영복 구매 탭에서 입문·정기 훈련·대회 목적별 핏·소재·관리 기준과 Speedo·arena·TYR·Mizuno·Nike Swim 공식 성인 사이즈표를 비교할 수 있습니다. 현재 모델·사이즈·착용감과 선택 신체 치수를 입력하면 5개 브랜드의 일반·훈련용 후보를 안내하며, 모델 전용 표가 필요한 레이싱·테크수트는 일반표 환산에서 제외합니다.
