...
현재 소스 기준 핵심 109개는 로컬에서 통과했습니다. 대표 홈과 주요 기능 페이지는 같은 카테고리형 메뉴를 공유하며, 로컬 데스크톱 23개 경로와 390px 모바일 드로어에서 현재 화면 강조·고정 배치·ESC 닫기·스크롤 잠금·가로 넘침 부재를 확인했습니다. 인증 Secrets가 필요한 운영 API 50개, 역할별 브라우저 28개와 Postman 요청 19개 전체 일괄 검사는 정기·수동 품질 게이트에서 판정합니다.
