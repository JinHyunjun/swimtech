...
- 단위·계약·지식 검색·Jira 통합·Postman 자산 계약 테스트 121개
...
현재 소스 기준 핵심 121개를 로컬에서 통과했습니다. 배포 기준 GitHub Actions [`31566609900`](https://github.com/JinHyunjun/swimtech/actions/runs/31566609900)에서는 핵심 121개, 운영 API 53개, 일반·데모·관리자 35개 화면과 공개 결과·클럽 화면 2개를 합친 브라우저 37개, Postman 25개 요청·40개 assertion이 모두 성공했습니다. 결과 카드·클럽 홍보 기능의 생성·공개·종료·권한·QR·390px 레이아웃과 관리자 지표까지 같은 실행에서 최종 판정했습니다.
