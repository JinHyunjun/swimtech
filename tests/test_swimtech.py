...
def test_equipment_load(page: Page):
    ...
    expect(page.locator("#brand-size-head")).to_contain_text("가슴 (in)")
    expect(page.locator("#brand-size-body tr").first).to_contain_text("33.1")
    page.click('[data-chart-unit="cm"]')
    expect(page.locator("#brand-size-head")).to_contain_text("가슴 (cm)")
    ...
    expect(page.locator("#measure-bust-conversion")).to_contain_text("83.1 cm")
    page.select_option("#measurement-unit", "cm")
    expect(page.locator("#measure-bust")).to_have_value("83.1")
    page.select_option("#measurement-unit", "in")
    expect(page.locator("#measure-bust")).to_have_value("32.7")
    ...
    expect(page.locator("#recommend-summary")).to_contain_text("inch 입력 → cm 정규화")
