...
3. 기존 운영 스키마는 Alembic baseline `20260723_01`로 등록되었고 현재 운영 head는 `20260723_04`이다. `20260723_02`는 개인화 온보딩, `20260723_03`은 세트 단위 수행 데이터, `20260723_04`는 클럽·반·범위별 멤버십을 추가한다.
...
9. 코치 강습 문서 생성·수정·선택 배포와 템플릿 폴백
10. Jira 설정 환경에서 과제 생성·완료·웹훅
11. 관리자 20/50/100 페이지 크기, 번호 페이지 이동, 페이지 조회 로그와 피드백 작성자
12. 브라우저 콘솔 오류, 실패 API, 모바일 레이아웃
13. `/meta`, `/upload`, `/viewer`가 영상 분석을 노출하지 않는지 확인
