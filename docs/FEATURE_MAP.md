...
| `/equipment` | 공개 | 보조 장비 사용법, 목적별 수영복 구매 기준, 5개 브랜드 성인 공식 사이즈표, 공식표·현재 라벨·구매 예정 국가 구분, 현재 모델·사이즈·착용감·선택 실측 기반 일반 훈련복 참고 비교, 모델별 소재·핏 면책과 테크수트 안전 경계 | 정적 콘텐츠·`swimwear-sizing.js` 클라이언트 비교 | 활성 |
